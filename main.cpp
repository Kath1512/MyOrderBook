...
void test(){
    ...
    book.add_order(Order(OrderType::Limit, TimeInForce::GoodTillCancel, 2, 50, 10, Side::Buy, 2));
    book.add_order(Order(OrderType::Limit, TimeInForce::GoodTillCancel, 2, 80, 10, Side::Buy, 2));
    book.add_order(Order(OrderType::Limit, TimeInForce::GoodTillCancel, 2, 90, 10, Side::Buy, 2));

    AddOrderResult res = book.add_order(Order(OrderType::Market, TimeInForce::ImmediateOrCancel, 3, 105, 50, Side::Sell, 3));
    std::cout << "Result: " << res << "\n";
